...
export function Hero() {
  return (
    <div className="bg-elevation-base bg-noise min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="text-[20px] text-gray-400 leading-relaxed mb-12 max-w-xl">
                Two <em className="italic not-italic">independent</em> products built for clarity, rigor, and long-term thinking.
              </p>
      ...
      {/* ═══════════════════════════════════════════════════════════════
          PRODUCTS OVERVIEW — Two Product Cards
      ═══════════════════════════════════════════════════════════════ */}
